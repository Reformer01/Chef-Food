    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            {/* Header */}
            <div className="relative bg-gray-50 p-8 pb-6 border-b border-gray-100">
              <button
                onClick={onClose}
              ...
              {mode === 'reset-sent' && (
                <button
                  ...
                  className="absolute top-4 left-4 p-2 hover:bg-gray-200 rounded-full transition-colors text-gray-500"
                >
              ...
              <div className="text-center">
                ...
                <p className="text-gray-500 mt-1 text-sm">{getSubtitle()}</p>
              </div>
            </div>
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-4 py-3 border rounded-xl focus:ring-2 focus:ring-gray-900 focus:border-gray-900 outline-none transition-all ${
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className={`w-full pl-10 pr-12 py-3 border rounded-xl focus:ring-2 focus:ring-gray-900 focus:border-gray-900 outline-none transition-all ${
                    ...
                    <button
                      type="submit"
                      disabled={authLoading}
                      className="w-full bg-gray-900 hover:bg-gray-800 disabled:bg-gray-400 text-white font-bold py-3 rounded-xl transition-colors flex items-center justify-center gap-2"
                    >
                      {authLoading ? (
                        <>
